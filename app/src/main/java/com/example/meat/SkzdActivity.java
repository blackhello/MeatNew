...
public class SkzdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skzd);
    ...
    public void btnsk(View view){
        ...
        MyDialog.message.setText("确认收到  武汉新鑫佳业商贸有限公司 货款\n\n货款金额："+ edss.getText().toString()+"元");
        MyDialog.btn_Ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyDialog.dismiss();
                Toast.makeText(SkzdActivity.this,"收款成功！",Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(SkzdActivity.this,MainActivity.class);
    ...
    public void btnmx(View v){
        Intent intent=new Intent(SkzdActivity.this,SkmxActivity.class);
        startActivity(intent);
    }
}
